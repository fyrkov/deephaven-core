...
public class GrpcTransportTestGwt extends AbstractAsyncGwtTestCase {
    ...
    /**
     * Dummy transport that never delivers headers and simply ends the stream, as happens when the server is
     * unreachable during a (re)connect attempt - the socket closes before any response is received.
     */
